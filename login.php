...
if (isset($_POST['login'])) {
    ...
    } else if (empty(trim($password))) { // Check if password is empty
...
<div id="login-page">
    ...
    <div class="login-border">
        <form id="loginSection" action="login.php" method="POST">
            ...
            <label for="username-box"></label><input id="username-box" class="loginPageArea" type="text" name="username" placeholder="Your Username" value="<?php echo htmlspecialchars($_SESSION['username'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
            <br>
